...
data class TupleDTO(
    ...
    // T3: Beta+ Y
    @SerializedName("t3_betaPlusY") val t3BetaPlusY: Long,
    // T4: Somma dei Blur Utenti (UserReq + UserTarget)
    @SerializedName("t4_sumUserBlur") val t4SumUserBlur: String,
    // T5: Somma dei Blur Server Specifici (SrvReq + SrvTarget)
    @SerializedName("t5_sumServerBlur") val t5SumServerBlur: Long,
    // T6: Tolleranza (Raggio in metri o unità mappa)
    @SerializedName("t6_tolerance") val t6Tolerance: String
)
